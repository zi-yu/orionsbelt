...
namespace Chronos.Info.Results {
	...
	public class ResourceNotAvailable : ResultItem {
		...
		public ResourceNotAvailable( string cat, string res )
		{
			category = cat;
			resource = res;
		}
		...
		{
			return "Failed: Resorce '" + Resource + "' not available in the '" + Category + "' category";
		}
		...
		public override string Name {
			get { return "ResourceNotAvailable"; }
		}

...
namespace Chronos.Messaging.Messages {
	...
	/// </summary>
	[FactoryKey("BattleTimedOut")]
	[Serializable]
	public sealed class BattleTimedOut : NotReplyableMessageInfo {
	
		#region Ctors

		/// <summary>Construtor de Message</summary>
		public BattleTimedOut() : base(MessageType.Battle)
		{
		}
		...
		public override string log( Message message )
		{
			...
			return "Battle TimedOut width '" + ruler + "' at " + args[1].ToString();
		}

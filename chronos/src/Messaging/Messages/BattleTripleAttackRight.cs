...
namespace Chronos.Messaging.Messages {
	...
	/// </summary>
	[FactoryKey("BattleTripleAttackRight")]
	[Serializable]
	public sealed class BattleTripleAttackRight : NotReplyableMessageInfo {

		#region Ctors

		/// <summary>Construtor de Message</summary>
		public BattleTripleAttackRight() : base(MessageType.Battle) { 
			 }
		...
		public override string log( Message message ) {
			...
			return string.Format("Triple Attack attack made {0} of damage to the Right that destroyed {1} {2}.",damage,quant,type);
		}

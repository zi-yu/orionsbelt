...
namespace Chronos.Messaging.Messages {
	...
	/// </summary>
	[FactoryKey("BuildingStarted")]
	[Serializable]
	public sealed class BuildingStarted : NotReplyableMessageInfo {
	
		#region Ctors

		/// <summary>Construtor de Message</summary>
		public BuildingStarted() : base(MessageType.PlanetManagement)
		{
		}
		...
		public override string log( Message message )
		{
			...
			return "Building '" + args[1].ToString() + "' on planet '" + planet +"' began construction";
		}

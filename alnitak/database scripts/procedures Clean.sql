...
CREATE PROC OrionsBelt_ChronosUniverseStarted
AS

UPDATE OrionsBelt_Start SET hasStarted = 1
...
CREATE PROC OrionsBelt_ChronosUniverseState
AS

Select hasStarted FROM OrionsBelt_Start
...
begin
	select 
		...
		Forum			= b.Name, 
		Description,
		Topics			= Customer2163.yaf_forum_topics(b.ForumID),
		Posts			= Customer2163.yaf_forum_posts(b.ForumID),
...
create procedure yaf_message_update(@MessageID int,@Priority int,@Subject nvarchar(100),@Flags int, @Message ntext) as
begin
	declare @TopicID	int
	declare	@ForumFlags	int
...
create procedure yaf_pmessage_markread(@UserPMessageID int=null) as begin
...
create procedure yaf_registry_list(@Name nvarchar(50) = null,@BoardID int = null) as
BEGIN
	if @BoardID is null
	begin
...
create procedure yaf_replace_words_save(@ID int=null,@badword nvarchar(255),@goodword nvarchar(255)) as
begin
	if @ID is null or @ID = 0 begin
...
create procedure yaf_topic_active(@BoardID int,@UserID int,@Since datetime,@CategoryID int=null) as
begin
	select
		c.ForumID,
		c.TopicID,
...
create procedure yaf_user_list(@BoardID int,@UserID int=null,@Approved bit=null,@GroupID int=null,@RankID int=null) as
begin
...
create procedure yaf_user_nntp(@BoardID int,@UserName nvarchar(50),@Email nvarchar(50)) as
begin
	declare @UserID int
...
create procedure yaf_user_recoverpassword(@BoardID int,@UserName nvarchar(50),@Email nvarchar(50),@Password nvarchar(32)) as
begin
	declare @UserID int
...
create procedure yaf_user_saveavatar(@UserID int,@Avatar nvarchar) as
begin
...
create procedure yaf_user_savesignature(@UserID int,@Signature nvarchar) as
begin

...
<div id="menu">
	...
	<dl>
		<dt>Orion's Belt</dt>
		<dd class="firstItem" ><a href="<%= OrionGlobals.AppPath %>index.aspx"><lang:Label ref="section_index" runat="server" /></a></dd>
	...
	<dl>
		...
		<dd class="firstItem" ><a href="<%= OrionGlobals.AppPath %>topalliances.aspx"><lang:Label ref="section_topalliances" runat="server" /></a></dd>
	...
	<dl>
		...
		<dd class="firstItem" ><a class="menuItem" href="<%= OrionGlobals.AppPath %>tournament/default.aspx?t=regicide"><lang:Label ref="regicide" runat="server" /></a><orion:TournamentNotifier Type="regicide" runat="server" /></dd>
	...
	<dl>
		...
		<dd class="firstItem" ><a href="<%= OrionGlobals.AppPath %>about.aspx"><lang:Label ref="section_about" runat="server" /></a></dd>
	...
	<dl id="historyItem">
		...
		<dd class="none" ><orion:RequestHistory runat="server" /></dd>
	</dl>
</div>

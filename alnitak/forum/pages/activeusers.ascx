...
<ItemTemplate>
<tr>
	<td class=post><asp:HyperLink id="Name" NavigateUrl='<%# string.Format("userinfo.aspx?id={0}",DataBinder.Eval(Container.DataItem,"UserID")) %>' Text='<%# Server.HtmlEncode(Convert.ToString(DataBinder.Eval(Container.DataItem,"Name"))) %>' runat="server" /></td>

...
<table align="center" cellspacing="1" cellpadding="0" class="forumContent" width="100%" id="LoginView" runat="server">
<tr>
...
<table class="forumContent" width=100% cellspacing=1 cellpadding=0 id=RecoverView runat=server visible=false>
<tr>

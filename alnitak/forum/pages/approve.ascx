...
<table class="forumContent" width="100%" cellspacing=1 cellpadding=0 id=approved runat=server visible=false>
	<tr>
...
<table class="forumContent" width="100%" cellspacing=1 cellpadding=0 id=error runat=server visible=false>
	<tr>
		<td class=header1 colspan=2><%= GetText("title") %></td>
	</tr>
	<tr>

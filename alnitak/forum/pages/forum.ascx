...
<tr>
	...
	<td class=post>
		...
		<asp:repeater runat="server" id="ActiveList">
			<ItemTemplate><a href='<%# string.Format("userinfo.aspx?id={0}",DataBinder.Eval(Container.DataItem, "User_ID"))%>'><%# Server.HtmlEncode(Convert.ToString(DataBinder.Eval(Container.DataItem, "user_nick"))) %></a></ItemTemplate>

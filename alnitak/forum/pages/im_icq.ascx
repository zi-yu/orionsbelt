<%@ Control language="c#" Codebehind="im_icq.ascx.cs" AutoEventWireup="false" Inherits="yaf.pages.im_icq" %>
<%@ Register TagPrefix="yaf" Namespace="yaf.controls" Assembly="Alnitak" %>

<yaf:PageLinks runat="server" id="PageLinks"/>

	<table class="forumContent" width="400px" border="0" cellpadding="0" cellspacing="1" align="center">
	<tr class="header2">

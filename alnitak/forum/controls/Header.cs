...
namespace yaf
{
	...
	public class Test : BaseControl
	{
		...
		protected override void Render(System.Web.UI.HtmlTextWriter writer)
		{
			...
			act_rank += "<table width=\"90%\" class=\"forumContent\" cellspacing=\"1\" border=\"0\" cellpadding=\"0\">";
			...
			{
				string img = "<img src='/themes/standard/user_rank1.gif'/>";
				...
				// Nome autore
				act_rank += string.Format( "<td width=\"75%\">&nbsp;<a href='{1}'>{0}</a></td>", r["Name"], OrionGlobals.resolveBase(string.Format("userinfo.aspx?id={0}",r["ID"]) ));

...
namespace yaf.controls
{
	...
	public class PopMenu : BaseControl, System.Web.UI.IPostBackEventHandler
	{
		...
		private void PopMenu_PreRender(object sender, EventArgs e)
		{
			...
			sb.AppendFormat("<table width='1%' class='forumContent' border=\"0\" cellspacing=\"0\" cellpadding=\"4\" id=\"{0}\" style=\"position:absolute;z-index:100;left:0;top:0;visibility:hidden;padding:0px;border:1px solid #FFFFFF;background-color:#FFFFFF\">",UniqueID);

...
<tr class="postheader">
	...
	<td width="140px" id="NameCell" runat="server">
		...
		<b><asp:hyperlink id="UserName" runat="server" href='<%# string.Format("userinfo.aspx?id={0}",DataRow["UserID"]) %>'><%# Server.HtmlEncode(DataRow["UserName"].ToString()) %></asp:hyperlink></b>
	</td>
	<td width="80%">
